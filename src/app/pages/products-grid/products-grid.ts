...
@Component({
  ...
  imports: [ProductCard, MatSidenav, MatSidenavContainer, MatSidenavContent, MatNavList,
    MatListItem, MatListItemTitle, RouterLink, TitleCasePipe, ToggleWishlistButton],
  template: `
...
export default class ProductsGrid {
  ...
  categories = signal<string[]>(['all', 'electronics','clothes' ,'accessories', 'home']);
